...
#define CUSTOM_MACHINE_NAME "AM8 Skr"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 182.71
  #define DEFAULT_bedKi  34.59
  #define DEFAULT_bedKd 643.38
 ...
 * - Individual axes can be disabled, if desired.pro
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS              33 // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)
